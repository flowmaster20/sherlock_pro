...
def get_data():
    ...
    # dzieli string na zmienne uzywajac wartosci podanej w nawiasie jako miejsce ciecia
    ...
    known_username = input(
        "paste any known usernames, that were used on socjal media before:").split(",")
    print(name, surname, l_number, nickname,
